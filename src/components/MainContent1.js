...
export default function MainContent1() {
    ...
    },
    {
        ...
        description: "I use React JS to build dynamic and fast web apps with reusable components and clean state management.", icons: <SiAffinitydesigner />

    }, {
        id: 5,
        course: "Responsive Design",
        description: "I make websites look great on all screen sizes — from mobile phones to desktops — using flexible layouts and modern CSS frameworks.", icons: <FaConnectdevelop />
